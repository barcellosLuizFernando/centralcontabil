 ...
 */
public class Cad_Fabricantes extends javax.swing.JInternalFrame {
        ...
        if (var_consulta == 1) {
            ...
            if (cn.conecta()) {
                try {
                    ...
                    String sql = "SELECT * FROM icms_fabricantes a "
                            + " WHERE a.id = " + id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            sql = "INSERT INTO ICMS_FABRICANTES (DESCRICAO, OBSERVACAO) "
            ...
            sql = "UPDATE ICMS_FABRICANTES SET DESCRICAO = '" + descricao
