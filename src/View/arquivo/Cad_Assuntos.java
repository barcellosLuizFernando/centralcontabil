 ...
 */
public class Cad_Assuntos extends javax.swing.JInternalFrame {
    ...
    public void MontaLista() {
        ...
        if (!"".equals(jTxtPesquisa_Multi.getText())) {
        ...
        } else { //Configura��o para quando n�o h� texto no campo pesquisa
            lista.setColumnCount(0);  //limpa a tabela
            lista.setRowCount(0);     //limpa a tabela
            cn.conecta();
            String sql = "SELECT * FROM CAD_ARQUIVO_ASSUNTOS "
            ...
            //Configura��o dos bot�es, quando n�o h� pesquisa
    ...
    public void IncluiPesquisa() {
        ...
        if (var_consulta == 1) {
            ...
            jTxtId.setText(jTblConsulta_Multi.getValueAt(0, 0).toString());
            ...
            cn.conecta();
            String sql = "SELECT * FROM CAD_ARQUIVO_ASSUNTOS a "
                    + " WHERE a.id = " + id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            String sql = "INSERT INTO CAD_ARQUIVO_ASSUNTOS (DESCRICAO, OBSERVACAO) "
            ...
            String sql = "UPDATE CAD_ARQUIVO_ASSUNTOS SET DESCRICAO = '" + descricao
            ...
            JOptionPane.showMessageDialog(rootPane, "Preencher descri��o!");
        }
