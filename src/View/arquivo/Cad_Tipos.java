 ...
 */
public class Cad_Tipos extends javax.swing.JInternalFrame {
    ...
    public void limpaCampos(){
     ...
     public void MontaLista() {
        ...
        if (!"".equals(jTxtPesquisa_Multi.getText())) {
            ...
            cn.conecta();
            String sql = "SELECT * FROM cad_arquivo_tipos "
     ...
     public void IncluiPesquisa() {
         ...
         if(var_consulta == 1){
            ...
            cn.conecta();
            String sql = "SELECT * FROM cad_arquivo_tipos a "
                    + " WHERE a.id = " +id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            String sql = "INSERT INTO CAD_ARQUIVO_TIPOS (DESCRICAO, OBSERVACAO) "
        ...
        // ALTERANDO DADOS    
            ...
            String sql = "UPDATE CAD_ARQUIVO_TIPOS SET DESCRICAO = '"+descricao
