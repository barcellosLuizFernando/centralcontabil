 ...
 */
public class Cad_Seguros_Coberturas extends javax.swing.JInternalFrame {
    ...
    public void limpaCampos(){
     ...
     public void IncluiPesquisa() {
         ...
         if(var_consulta == 1){
            ...
            cn.conecta();
            String sql = "SELECT * FROM cad_seguros_coberturas a "
                    + " WHERE a.id = " +id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            String sql = "INSERT INTO cad_seguros_coberturas (DESCRICAO, OBSERVACAO) "
        ...
        // ALTERANDO DADOS    
            ...
            String sql = "UPDATE cad_seguros_coberturas SET DESCRICAO = '"+descricao
