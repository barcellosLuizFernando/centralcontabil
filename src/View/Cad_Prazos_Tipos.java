 ...
 */
public class Cad_Prazos_Tipos extends javax.swing.JInternalFrame {
    ...
    public void MontaLista() {
        ...
        if (!"".equals(jTxtPesquisa_Multi.getText())) {
            cn.conecta();
            String sql = "SELECT * FROM cad_prazos_tipos "
    ...
    public void IncluiPesquisa() {
        ...
        if (var_consulta == 1) {
            ...
            cn.conecta();
            String sql = "SELECT * FROM cad_prazos_tipos a "
                    + " WHERE a.id = " + id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            String sql = "INSERT INTO CAD_PRAZOS_TIPOS (DESCRICAO, OBSERVACAO) "
            ...
            String sql = "UPDATE CAD_PRAZOS_TIPOS SET DESCRICAO = '" + descricao
