 ...
 */
public class Cad_Departamentos extends javax.swing.JInternalFrame {
    ...
    public void MontaLista() {
        ...
        if (!"".equals(jTxtPesquisa_Multi.getText())) {
            ...
            cn.conecta();
            String sql = "SELECT * FROM CAD_ARQUIVO_DEPARTAMENTOS "
    ...
    public void IncluiPesquisa() {
        ...
        if (var_consulta == 1) {
            ...
            cn.conecta();
            String sql = "SELECT * FROM CAD_ARQUIVO_DEPARTAMENTOS a "
                    + " WHERE a.id = " + id;
    ...
    private void jBtnGravarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jBtnGravarActionPerformed
        ...
        if (!"".equals(jTxtDescricao.getText())
            ...
            String sql = "INSERT INTO CAD_ARQUIVO_DEPARTAMENTOS (DESCRICAO, OBSERVACAO) "
            ...
            String sql = "UPDATE CAD_ARQUIVO_DEPARTAMENTOS SET DESCRICAO = '" + descricao
